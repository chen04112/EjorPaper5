...
If the submission system accepts only one supplementary file, submit the Excel workbook. If it accepts an archive, submit this entire folder so that the instances, generator, raw CSV files, and manifests remain available.
